    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#FDFDFF] text-slate-900 font-sans selection:bg-indigo-100">
                    ...
                    <div className="flex items-center gap-3">
                        {auth.user ? (
                            <Link
                                ...
                                className="px-6 py-2.5 bg-slate-900 text-white rounded-xl font-semibold hover:bg-slate-800 transition-all shadow-md"
                            >
                                Go to Dashboard
                            </Link>
                        ) : (
                            <>
                                ...
                                {canRegister && (
                                    <Link
                                        href={route('register')}
                                        className="px-6 py-2.5 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100"
                                    >
                                        Register
                                    </Link>
                                )}
                ...
                {/* --- HERO SECTION --- */}
                <header className="max-w-5xl mx-auto pt-16 pb-20 px-6 text-center">
                    <motion.div 
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6 }}
                    >
                        <h1 className="text-6xl md:text-7xl font-black tracking-tighter text-slate-950 mb-8 leading-[1.1]">
                ...
                <section className="max-w-7xl mx-auto px-6 pb-32">
                    <div className="grid grid-cols-1 md:grid-cols-6 md:grid-rows-2 gap-4 auto-rows-[240px]">
                        
                        {/* FEATURE 1: CREATOR STUDIO */}
                        <div className="md:col-span-3 md:row-span-2 bg-white border border-slate-200 rounded-[3rem] p-12 flex flex-col justify-between shadow-sm hover:shadow-xl hover:border-indigo-100 transition-all group overflow-hidden relative">
                            <div className="relative z-10">
                                ...
                                <h3 className="text-4xl font-bold text-slate-900 mb-6">Creator Studio</h3>
                            ...
                            <div className="relative z-10 mt-8 flex gap-2">
                                <span className="px-4 py-2 bg-slate-50 border border-slate-100 rounded-full text-sm font-medium text-slate-600">Drag & Drop</span>
                                <span className="px-4 py-2 bg-slate-50 border border-slate-100 rounded-full text-sm font-medium text-slate-600">Custom Branding</span>
                            </div>
                        ...
                        <div className="md:col-span-3 bg-indigo-600 text-white rounded-[3rem] p-10 flex items-center gap-8 shadow-xl relative overflow-hidden group">
                        ...
                        <div className="md:col-span-2 bg-slate-900 text-white rounded-[3rem] p-10 flex flex-col justify-between hover:scale-[0.98] transition-transform shadow-2xl">
                            <div>
                        ...
                        {/* FEATURE 4: ANALYTICS */}
                        <div className="md:col-span-1 bg-white border border-slate-200 rounded-[3rem] p-10 flex flex-col items-center justify-center hover:bg-indigo-50 transition-colors shadow-sm">
